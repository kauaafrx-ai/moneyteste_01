...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Igrris Fiance" },
      { name: "description", content: "Aurum: controle financeiro  gastos,gamhos,investimentos e educação fincanceira premium pessoal , elegante e inteligente." },
      { name: "theme-color", content: "#f7faf8" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:title", content: "Igrris Fiance" },
      { name: "twitter:title", content: "Igrris Fiance" },
      { property: "og:description", content: "Aurum: controle financeiro  gastos,gamhos,investimentos e educação fincanceira premium pessoal , elegante e inteligente." },
      { name: "twitter:description", content: "Aurum: controle financeiro  gastos,gamhos,investimentos e educação fincanceira premium pessoal , elegante e inteligente." },
